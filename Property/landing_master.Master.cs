    ...
    public partial class landing_master : System.Web.UI.MasterPage
    {
        ...
        private void SetValuesMetatags()
        {
            ...
            if (PageTitle == "LandingPage")
            {
                ...
                fbProprtyImage.Content = "http://jagwant.only4agents.com/Images/canada.jpg";
                fbProprtyTitle.Content = "Find Your Dream Home.";
                fbProprtyUrl.Content = "http://jagwant.only4agents.com/landing_page.aspx?PageTitle=LandingPage";
                fbProprtyShareType.Content = "Property";

                ProprtyDes.Content = "Get know what your neighbors are selling at jagwan singh website. We offer the complete information for real estate properties for sale. ";
                siteTitle.Text = "Get Know What Your Neighbours Are Selling - Jagwant Singh";
            }
            else if (PageTitle == "HomeWorth")
            {
                ...
                fbProprtyUrl.Content = "http://jagwant.only4agents.com/Home_Worth.aspx?PageTitle=HomeWorth";
                fbProprtyShareType.Content = "Property";
                ...
                siteTitle.Text = "Get Your Home Market Value Estimate Online - Jagwant Singh";
            }
