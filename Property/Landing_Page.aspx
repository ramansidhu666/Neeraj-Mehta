...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    $(document).ready(function () {
        $("#shareBtn").click(function () {           
            var URL = http://neerajmehta.ca/landing_page.aspx?PageTitle=LandingPage';
        ...
        <div id="main-wrap" class="clearfix">
            <div  class="main-container bg clearfix ">
                ...
                <button type="button"  style="background-color:gold;" id="shareBtn" class="btn btn-success clearfix shre_bttn">Share Me</button>
                   <%-- <a href="#" id="sharetweet" class="btn btn-success clearfix">Share Me On Tweet</a>--%>
                </div>
                </div>
                <div class="col-md-5 col-sm-5">
                </div>
